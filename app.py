...
# ✅ Simpan file credentials.json dari ENV (yang sudah dijadikan dict)
google_creds_string = os.environ["GOOGLE_CREDS_JSON"]
google_creds_dict = json.loads(google_creds_string)
